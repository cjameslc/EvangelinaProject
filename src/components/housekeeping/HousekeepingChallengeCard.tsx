...
// The exact same Elite Booker Challenge world map + Achievements gallery
// shown on My Earnings, surfaced here too for the logged-in cleaner — same
// data source (/api/my-earnings), same tiers/rewards/pool as a Booker (many
// staff here do both jobs), just rendered inline on the Housekeeping page
// instead of requiring a separate visit. Renders nothing if this account
// has no linked Employee record or isn't eligible for the challenge.
