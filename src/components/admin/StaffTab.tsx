...
type WeekBooking = { date: string; stayType: string; booker: Person; cleaner: Person };
...
export function StaffTab({
  ...
  const thisWeekTotals = useMemo(() => {
    ...
    const normalizedBookings = bookingsThisWeek.map((b) => ({ bookerId: b.booker?.id ?? null, cleanerId: b.cleaner?.id ?? null, stayType: b.stayType }));
