...
// Revenue/Net Profit/Occupancy/ADR/RevPAR/Total Bookings moved to the new
// premium MetricsHero + MetricKpiCard grid above this row (analytics/
// page.tsx) — kept here, not deleted, since this row's job is now
// specifically the metrics that grid doesn't cover, not a duplicate
// display of the same six numbers right underneath it.
